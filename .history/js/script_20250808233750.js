document.addEventListener('DOMContentLoaded', () => {
    ...
    const genderData = document.querySelectorAll('#gender'),
        sizeData = document.querySelectorAll('.calculating__choose_medium'),
        activeData = document.querySelectorAll('.calculating__choose_big'),
    ...
    genderData
        field.addEventListener('click', (e) => {
            ...
            if (target && target.classList.contains('calculating__choose-item')) {
                params.gender = target.textContent;
                targe
            }
