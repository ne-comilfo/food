document.addEventListener('DOMContentLoaded', () => {
    ...
    const genderData = document.querySelector('.calculating__choose #gender'),
        sizeData = document.querySelector('.calculating__choose .calculating__choose_medium'),
        activeData = document.querySelector('.calculating__choose .calculating__choose_big'),
        calcResult = document.querySelector('.')
